...
function trackedEvents() {
  return [
    ...
    ["kbw-2026", "Korea Blockchain Week 2026", "2026-09-29", "2026-10-01", "Korea", "Seoul, Korea", "in-person", "Crypto / Institutional", "high", "Korea anchor crypto event; official page positions it as Asia's premier crypto event and gateway to the Korean market.", "Korea Blockchain Week", "https://koreablockchainweek.com/", "register", "Track main conference plus side events for funds, exchanges, builders, and market-structure contacts."],
    ...
    ["hk-fintech-week-2026", "Hong Kong FinTech Week x StartmeupHK 2026", "2026-11-02", "2026-11-06", "East Asia / Hong Kong", "HKCEC and multiple venues, Hong Kong", "in-person", "Fintech / AI / Web3", "medium", "Asia flagship fintech event; main conference is Nov 2-3 at HKCEC, with broader festival/community events through Nov 6.", "Hong Kong FinTech Week", "https://www.fintechweek.hk/", "watch", "Track agenda for fintech, AI, Web3, digital assets, and institutional finance. Not a pure quant event."],
